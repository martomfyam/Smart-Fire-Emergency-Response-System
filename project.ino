...
/* 
  ...
  Email: info@martinmuthomi.co.ke
   ...
   Digital Pin 7: GSM (7).
   Digital Pin 8: GSM (8).
   Digital Pin 11: IR receiver.
   Analog pin A0: piezo buzzer (passive). to Digital Pin 10
...
//   Serial.println(smokevalue);
    ...
    String message = "Their is an incoming fire alarm. Kindly act accordingly. You can cancel within 30sec by replying with OFF.";
...
void triggerDoorlock(){
 ...
 void receiveSMS(){
   ...
   //    initialTime = millis();
   //    alarmOn();
   alarmStatus = "on"; //change coz door wouldnt open
    textMessage = "";   
  }
